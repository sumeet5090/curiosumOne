                    ...
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <p class="lead text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed pellentesque purus lorem, ac eleifend augue fermentum in. </p>
                                <div class="btn-wrapper">
                                    <base-button tag="a" href="#sponsers" class="mb-3 mb-sm-0 text-white" type="primary" icon="fa fa-star">Sponsers</base-button>
                                    <base-button tag="a" href="#about" class="mb-3 mb-sm-0 text-white" type="primary" icon="fa fa-question">About</base-button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="row row-grid">
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    <icon name="fa fa-bell" type="success" rounded class="mb-4">
                                    </icon>
                                    <h6 class="text-success text-uppercase">Announcements</h6>
                                    <p class="description mt-3">Get the latest updates.</p>
                                    <div>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    <icon name="fa fa-calendar" type="warning" rounded class="mb-4">
                                    </icon>
                                    <h6 class="text-warning text-uppercase">Schedule</h6>
                                    <p class="description mt-3">What's going on today!</p>
                                    <div>
            ...
            <div class="container">
                <div class="row row-grid align-items-center">
                    ...
                    <div class="col-md-6 order-md-1">
                        <div class="pr-md-5">
                            <icon name="fa fa-question" class="mb-5" size="lg" type="info" shadow
                                  rounded></icon>
                            <h3>About Section</h3>
                            <p></p>
                            <ul class="list-unstyled mt-5">
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="info" circle class="mr-3" icon="ni ni-settings-gear-65"></badge>
                                        <h6 class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="info" circle class="mr-3" icon="fa fa-star"></badge>
                                        <h6 class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="info" circle class="mr-3" icon="ni ni-satisfied"></badge>
                                        <h6 class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h6>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="col-md-6">
                        <div class="card bg-default shadow border-0">
                            ...
                            <blockquote class="card-blockquote">
                                ...
                                <p class="lead text-italic text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed pellentesque purus lorem, ac eleifend augue fermentum in. Aliquam erat volutpat. </p>
                            </blockquote>
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-4">
                            <img v-lazy="'./../assets/img/theme/team-1-800x800.jpg'"
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-4">
                            <img v-lazy="'./../assets/img/theme/team-2-800x800.jpg'"
                                 class="rounded-circle img-center img-fluid shadow shadow-lg--hover"
                                 style="width: 200px;">
                            <div class="pt-4 text-center">
                                <h5 class="title">
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-4">
                            <img v-lazy="'./../assets/img/theme/team-3-800x800.jpg'"
                                 class="rounded-circle img-center img-fluid shadow shadow-lg--hover"
                                 style="width: 200px;">
                            <div class="pt-4 text-center">
                                <h5 class="title">
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-4">
                            <img v-lazy="'./../assets/img/theme/team-4-800x800.jpg'"
                                 class="rounded-circle img-center img-fluid shadow shadow-lg--hover"
                                 style="width: 200px;">
                            <div class="pt-4 text-center">
                                <h5 class="title">
