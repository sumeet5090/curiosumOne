          ...
          <card class="col-sm-10 col-md-8 col-lg-6">
            <b-form @submit.prevent="onSubmit" @reset.prevent="onReset">
              <b-form-group
                ...
                description="Choose an unique name which describes your team."
              >
                <base-input
                  addon-left-icon
              ...
              <b-form-group
                id="form-institutionname"
                label="Institution Details:"
                label-for="form-institutionname--input"
                description="Enter your institution details."
              >
                <base-input
                  id="form-institutionname--input"
                  type="text"
                  v-model="teamForm.institution.name"
                  required
                ...
                <base-input
                  id="form-institutionname--input"
                  type="text"
                  v-model="teamForm.institution.address"
                  required
                ...
                <base-input
                  id="form-institutionname--input"
                  type="text"
                  v-model="teamForm.institution.short_name"
                  required
              ...
              <b-form-group
                id="form-picture-url"
                label="Team logo:"
                label-for="form-picture-url--input"
                description="Link to the team profile picture."
              >
                <base-input
                  id="form-picture-url--input"
                  type="link"
                  v-model="teamForm.logo_url"
                  required
                  placeholder="https://example.website.com/images/demo.jpg"
                ></base-input>
              </b-form-group>
              <b-form-group
                id="form-social-links"
                label="Social Media"
                label-for="form-social-links--input"
                description="Links to your teams social media"
              >
                <base-input
                  addon-left-icon="fa fa-link text-dark"
                  placeholder="https://examplewebsite.com"
                  v-model="teamForm.website_url"
                ></base-input>
                <base-input
                  addon-left-icon="fab fa-facebook-f"
                  placeholder="https://facebook.com/example"
                  v-model="teamForm.social.facebook"
                ></base-input>
                <base-input
                  addon-left-icon="fab fa-instagram text-danger"
                  placeholder="https://instagram.com/example"
                  v-model="teamForm.social.instagram"
                ></base-input>
                <base-input
                  addon-left-icon="fab fa-twitter"
                  placeholder="https://twitter.com/example"
                  v-model="teamForm.social.twitter"
                ></base-input>
              </b-form-group>
              <b-form-group
                id="form-bio"
              ...
              <b-form-group
                id="form-members"
                label="Members:"
                label-for="form-members--input"
                description="Search email and press enter."
              >
