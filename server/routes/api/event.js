...
router.put('/:id/announcement/:annc_id', helper.hasRole("admin"), eventCont.updateAnnouncement)
...
router.delete('/:id/announcement/:annc_id', helper.hasRole("admin"), eventCont.deleteAnnouncement)
